...
type TailRequest struct {
	...
	Job      string                 `protobuf:"bytes,4,opt,name=job,proto3" json:"job,omitempty"` // Added job field for filtering
}
...
func (x *TailRequest) GetJob() string {
	if x != nil {
		return x.Job
	}
	return ""
...
type LogEntry struct {
	...
	Job       string                 `protobuf:"bytes,7,opt,name=job,proto3" json:"job,omitempty"` // Added job field
}
...
type TailResponse struct {
	...
	Job     string      `protobuf:"bytes,6,opt,name=job,proto3" json:"job,omitempty"` // Added job field to response
}
...
func (x *TailResponse) GetJob() string {
	if x != nil {
		return x.Job
	}
	return ""
...
var file_io_defang_v1_fabric_proto_rawDesc = []byte{
	...
	0x69, 0x6e, 0x4a, 0x04, 0x08, 0x02, 0x10, 0x03, 0x22, 0x81, 0x01, 0x0a, 0x0b, 0x54, 0x61, 0x69,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x65, 0x74, 0x61, 0x67, 0x12, 0x10, 0x0a, 0x03, 0x6a, 0x6f,
	0x62, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6a, 0x6f, 0x62, 0x22, 0xca, 0x01, 0x0a,
	...
	0x09, 0x52, 0x04, 0x68, 0x6f, 0x73, 0x74, 0x12, 0x10, 0x0a, 0x03, 0x6a, 0x6f, 0x62, 0x18, 0x07,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6a, 0x6f, 0x62, 0x22, 0x9a, 0x01, 0x0a, 0x0c, 0x54, 0x61,
	...
	0x73, 0x74, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x68, 0x6f, 0x73, 0x74, 0x12, 0x10,
	...
	0x5f, 0x0a, 0x0d, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65,
